      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-4" align="center">
               <img src="../../forms/form_deuk_spine_Cervical/deuk.png" alt="form_deuk_spine" style="width:80%">
          </div>
          <div class="col-8">
          ...
          <div class="row" style="margin-top : 20px;">
               ...
               <div class="col-6">
                    ...
                    Muscle : <input type="checkbox" <?php echo ($check_res["n_Muscle"] == 1) ? "checked" : ""; ?> name="n_Muscle" id="n_Muscle"> normal&ensp;  <input type="checkbox" <?php echo ($check_res["p_Muscle"] == 1) ? "checked" : ""; ?> name="p_Muscle" id="p_Muscle"> spasms &ensp; R &ensp; L &ensp; B <br>
               </div>
          </div>
          <br>
          <div class="row">
               <div class='col-6'>
                    ...
                    <div style="border:1px solid black;padding: 7px;">
                         ...
                         * DLDR : &ensp; R &emsp;&emsp; L <br>
                         C3-4 &emsp; C4-5 &emsp; C5-6 &emsp; C6-7 &emsp; C7-T1 <br>
                         * DPR : <br>
	                    <table>
                              <tr>
                                   <td>R &ensp;</td>
               ...
               <div class='col-6'>
                    <div class="" style="border:1px solid;font-weight:bold;padding-left:10px"> 
                         <input type="checkbox" <?php echo ($check_res["check1"] == 1) ? "checked" : ""; ?> name="check1" id="check1">&ensp; Cervicalgia (M54.2) <br>
                         <input type="checkbox" <?php echo ($check_res["check2"] == 1) ? "checked" : ""; ?> name="check2" id="check2">&ensp; Cervicobrachial Syndrome(M53) <br>
                         <input type="checkbox" <?php echo ($check_res["check3"] == 1) ? "checked" : ""; ?> name="check3" id="check3">&ensp; Facet Syndrome - Cervical (M53.82)<br>
                         <input type="checkbox" <?php echo ($check_res["check4"] == 1) ? "checked" : ""; ?> name="check4" id="check4">&ensp; HNP/disc bulge w/Radiculopathy C2-3 (M50.11)<br>
                         <input type="checkbox" <?php echo ($check_res["check5"] == 1) ? "checked" : ""; ?> name="check5" id="check5">&ensp; HNP/disc bulge w/Radiculopathy C3-4 (M50.10)<br>
                         <input type="checkbox" <?php echo ($check_res["check6"] == 1) ? "checked" : ""; ?> name="check6" id="check6">&ensp;  HNP/disc bulge w/Radiculopathy C4-5 (M50.121)<br>
                         <input type="checkbox" <?php echo ($check_res["check7"] == 1) ? "checked" : ""; ?> name="check7" id="check7">&ensp;  HNP/disc bulge w/Radiculopathy C5-6 (M50.122)<br>
                         <input type="checkbox" <?php echo ($check_res["check8"] == 1) ? "checked" : ""; ?> name="check8" id="check8">&ensp;  HNP/disc bulge w/Radiculopathy C6-7 (M50.123)<br>
                         ...
                         <input type="checkbox" <?php echo ($check_res["check11"] == 1) ? "checked" : ""; ?> name="check11" id="check11">&ensp; Radiculopathy/Radiculitis-Cervical(M54.12)<br>
                         <input type="checkbox" <?php echo ($check_res["check12"] == 1) ? "checked" : ""; ?> name="check12" id="check12">&ensp; Stenosis Cervical (M48.02) <br>
                         <input type="checkbox" <?php echo ($check_res["check13"] == 1) ? "checked" : ""; ?> name="check13" id="check13">&ensp; Adjacent Segment Disease - Cervical(M50.30) <br>
                         <input type="checkbox" <?php echo ($check_res["check14"] == 1) ? "checked" : ""; ?> name="check14" id="check14">&ensp; Carpal Tunnel Syndrome RT(G56.01) LT(G56.02) <br>
                         <input type="checkbox" <?php echo ($check_res["check15"] == 1) ? "checked" : ""; ?> name="check15" id="check15">&ensp;  Ulnar neuropathy RT(G56.21) LT(G56.22) <br>
                         <input type="checkbox" <?php echo ($check_res["check16"] == 1) ? "checked" : ""; ?> name="check16" id="check16">&ensp;  Shoulder pain RT(M25.511) LT(M25.512) 
                    </div>
                    <br>
