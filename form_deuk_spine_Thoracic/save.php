...
$Best= $_POST['Best'];
$mid_back= $_POST['mid_back'];
$chest_wall= $_POST['chest_wall'];
$bp1= $_POST['bp1'];
$bp2= $_POST['bp2'];
$hrs= $_POST['hrs'];
$o2= $_POST['o2'];
